...
*/
public class MDouble extends Number implements Comparable<MDouble>, Mutable<Number> {
/**
...
* @since 2.5
*/
public MDouble(String value) throws NumberFormatException {
super();
...
return obj instanceof MDouble
&& Double.doubleToLongBits(((MDouble) obj).value) == Double.doubleToLongBits(value);
}
/**
...
*/
public int compareTo(MDouble other) {
